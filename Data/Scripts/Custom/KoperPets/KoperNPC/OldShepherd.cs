...
{
    public class OldShepherd : BaseCreature
    {
        //public override bool IsInvulnerable { get { return true; } } // Makes NPC unkillable

        private static readonly List<SBInfo> _SBInfos = new List<SBInfo>(); // Vendor inventory placeholder

        //protected override List<SBInfo> SBInfos { get { return _SBInfos; } } // Define vendor inventory

        [Constructable]
        public OldShepherd() : base(AIType.AI_Citizen, FightMode.None, 10, 1, 0.4, 1.6)
        {
        ...
        /*public override void InitSBInfo(Mobile vendor)
        {
            _SBInfos.Clear(); // Clear old info
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            {
                SayTo(player, "Ah, you're interested in raising strong and noble beasts? Ask me about 'breeding', 'nursery', or 'adjectives'!");
            }
            base.OnSpeech(e);
        }
