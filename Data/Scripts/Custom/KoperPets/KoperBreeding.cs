...
// expand logic to check if level = maxlevel before allowing to breed, add associated error messages
// if generation dif greater than 3: too big of a split, maybe use reallevel to calc (pedigree + 1)*level
