...
namespace Server.Custom.KoperPets
{
    public class KoperPetCommands
    {
        public static void Initialize()
        {
            ...
            CommandSystem.Register("ShowNursery", AccessLevel.Player, new CommandEventHandler(ShowNursery_OnCommand));
            CommandSystem.Register("SpawnShepherd", AccessLevel.Administrator, new CommandEventHandler(SpawnShepherd_OnCommand));
        }

        [Usage("GainXP <amount>")] // DEBUG COMMAND
        ...
        [Usage("SpawnShepherd")]
        [Description("Spawns the Old Shepherd NPC at your location.")]
        public static void SpawnShepherd_OnCommand(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            OldShepherd shepherd = new OldShepherd();
            shepherd.MoveToWorld(from.Location, from.Map);
        }

        [Usage("ShowNursery")]
        [Description("Opens the Koper Pet Nursery Gump to view stored and active pets.")]
        public static void ShowNursery_OnCommand(CommandEventArgs e)
        {
            PlayerMobile player = e.Mobile as PlayerMobile;

            if (player != null)
            {
                player.SendGump(new KoperNurseryGump(player));
            }
        }
